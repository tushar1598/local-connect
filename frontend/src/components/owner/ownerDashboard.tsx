...
import BusinessPerformance from "./newlook/BusinessPerformance";
import Notifications from "./newlook/Notifications";
import OwnerHero from "./newlook/OwnerHero";
import QuickActions from "./newlook/QuickActions";
import QuickStats from "./newlook/QuickStats";
import RecentBookings from "./newlook/RecentBookings";
import RevenueChart from "./newlook/RevenueChart";
import TodayActivity from "./newlook/TodayActivity";
